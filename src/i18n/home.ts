  ...
  fr: {
    ...
    contact: {
      ...
      formulaire: {
        ...
        erreurVerification: 'La vérification anti-robots a échoué. Réessayez, ou écrivez-moi directement.',
        sansJs: 'Ce formulaire demande JavaScript pour la vérification anti-robots. Écrivez-moi directement à l’adresse ci-dessous, la réponse est la même.',
        ou: 'ou directement :',
      },
    },
  },
  en: {
    ...
    contact: {
      ...
      formulaire: {
        ...
        erreurVerification: 'The anti-bot check failed. Try again, or write to me directly.',
        sansJs: 'This form needs JavaScript for its anti-bot check. Write to me directly at the address below — same answer, same person.',
        ou: 'or directly:',
      },
    },
  },
